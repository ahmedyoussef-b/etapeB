...
import { LayoutDashboard, HelpCircle, FileText, MessageSquare, BookOpen, Image, Database, Video, BarChart3, Users, ClipboardList, Bot, Sun, Moon, GitBranch, Activity, User, UserPlus } from "lucide-react";
...
export const DashboardSidebar = React.memo(function DashboardSidebar({ collapsed }: { collapsed?: boolean } = {}) {
  ...
  const rawRole = (session?.user?.role as Role | string) || "rondier";
  ...
  const homeActive = pathname === roleHome.href || pathname.startsWith(roleHome.href + "/");
